...
var Paypal = function (config) {
    ...
    var defaultConfig = {
        ...
        responseFormat:     'JSON',
        sandbox:            false,
        productionUrl:      'https://svcs.paypal.com/',
        sandboxUrl:         'https://svcs.sandbox.paypal.com/',
...
Paypal.prototype.getPaymentOptions = function(payKey, callback) {
    ...
    this.callApiMethod('AdaptivePayments/GetPaymentOptions', data, callback);
};
...
Paypal.prototype.getPaymentDetails = function(params, callback) {
    ...
    this.callApiMethod('AdaptivePayments/PaymentDetails', data, callback);
};

Paypal.prototype.createPayment = function(data, callback) {
    var config = this.config;

    this.callApiMethod('AdaptivePayments/Pay', data, function(err, res) {
...
Paypal.prototype.refundPayment = function(params, callback) {
    ...
    this.callApiMethod('AdaptivePayments/Refund', data, callback);
};

Paypal.prototype.createAccount = function(data, callback) {
    data = merge(defaultPayload(), data);

    this.callApiMethod('AdaptiveAccounts/CreateAccount', data, callback);
};
